...
namespace AfricasTalking
{
    ...
    public class AfricasTalkingGateway
    {
        ...
        public void uploadMediaFile(string url_, string phoneNumber_)
        {
            Hashtable data = new Hashtable();
            data["username"] = _username;
            data["url"] = url_;
        ...
        public dynamic initiateMobilePaymentCheckout(string productName_, string phoneNumber_, string currencyCode_, decimal amount_,
            Dictionary<string, string> metadata_)
        {
