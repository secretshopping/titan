...
namespace Titan
{
    public class OfferwallFileManager
    {
        public static string HANDLER_LOCATION = "Handlers/OfferwallCreator.ashx";
        public static string BASE_HANDLER_FILE = "Handlers/Offerwalls/BaseHandler.ashx";
        public static string HANDLER_FOLDER = "Handlers/Offerwalls/";
