...
public class AdPackNormalBannersCache : CacheBase
{
    protected override string Name { get { return "AdPackNormalBanners"; } }
    ...
    protected override object GetDataFromSource()
    {
        ...
        string command = "SELECT DISTINCT apa.* FROM AdPacksAdverts apa INNER JOIN AdPacks ap ON apa.Id = ap.AdPacksAdvertId WHERE ap.TotalNormalBannerImpressions < ap.NormalBannerImpressionsBought AND apa.NormalImagePath IS NOT NULL ";
