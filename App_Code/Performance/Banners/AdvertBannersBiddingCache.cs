...
public class AdvertBannersBiddingCache : CacheBase
{
    protected override string Name { get { return "AdvertBannersBiddingCache"; } }
    ...
    {
        return BannerBiddingDimensionsDictionary.Initialize();
    }
}