...
public partial class Controls_RevShareConstantBanner : System.Web.UI.UserControl
{
    /// <summary>
    ...
    private readonly string sessionContainerName = "Controls_RevShareConstantBanner";

    private Control GetBanner()
    {
        return AdPackBannerDisplayer.GetBanner(BannerAdvert.Type.Constant, IndexOnPage);
    }
